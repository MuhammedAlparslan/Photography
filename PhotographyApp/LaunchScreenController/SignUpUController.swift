...
class SignUpUController: UIViewController {
    ...
    @IBAction func nextClicked(_ sender: Any) {
        let controller = storyboard?.instantiateViewController(identifier: "SignUpEController") as! SignUpEController
