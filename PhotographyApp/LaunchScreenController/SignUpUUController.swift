...
class SignUpUUController: UIViewController {
    ...
    @IBAction func nextClicked(_ sender: Any) {
        let controller = storyboard?.instantiateViewController(identifier: "SignUpPController") as! SignUpPController
